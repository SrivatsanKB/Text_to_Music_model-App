...
def save_audio(samples: torch.Tensor):
    ...
    sample_rate = 32000
    save_path = r"\Users\balaj\Downloads\audio_output"
    ...
    return audio_path  # Return the path where the audio file is saved
...
def main():
    ...
    if text_area and time_slider:
        ...
        audio_filepath = save_audio(music_tensors)  # Update to get the audio file path
